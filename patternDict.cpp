//
// File generated by rootcint at Fri Oct  3 21:51:23 2014
...
void solve_data::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "stable", &stable);
...
static void G__setup_memvarsolve_data(void) {
   ...
   G__memvar_setup((void*)((long)(&p->stable)-(long)(p)),103,0,0,-1,-1,-1,1,"stable=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__patternDictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
