//
// File generated by rootcint at Tue Nov 26 23:49:27 2013
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::solve_data*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("solve_data", ::solve_data::Class_Version(), "./pattern.h", 15,
...
void solve_data::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "params", (void*)&params);
      R__insp.InspectMember("input_sample", (void*)&params, "params.", false);
...
G__linked_taginfo G__patternDictLN_input_sample = { "input_sample" , 115 , -1 };
...
extern "C" void G__cpp_setup_tagtablepatternDict() {
   ...
   G__get_linked_tagnum_fwd(&G__patternDictLN_input_sample);
