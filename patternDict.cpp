//
// File generated by rootcint at Wed Nov 27 00:04:26 2013
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::solve_data*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("solve_data", ::solve_data::Class_Version(), "./pattern.h", 18,
...
void input_sample::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "k_1", &k_1);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "k_2", &k_2);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "k_3", &k_3);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "k_4", &k_4);
...
static void G__setup_memvarinput_sample(void) {
   ...
   G__memvar_setup((void*)((long)(&p->k_1)-(long)(p)),100,0,0,-1,-1,-1,1,"k_1=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->k_2)-(long)(p)),100,0,0,-1,-1,-1,1,"k_2=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->k_3)-(long)(p)),100,0,0,-1,-1,-1,1,"k_3=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->k_4)-(long)(p)),100,0,0,-1,-1,-1,1,"k_4=",0,(char*)NULL);
